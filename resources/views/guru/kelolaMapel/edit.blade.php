                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="/kelMapel/{{ $mapel->id }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="mapel">Mapel</label>
                                            <input type="text" name="mapel" class="form-control @error('mapel') is-invalid @enderror" id="mapel" placeholder="Enter Mapel" value="{{ old('mapel', $mapel->mapel) }}">
                                            @error('mapel')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img id="imagePreview" src="{{ asset('storage/' . $mapel->gambar) }}" alt="Preview Gambar" style="display: block; max-width: 100%; height: auto;">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
